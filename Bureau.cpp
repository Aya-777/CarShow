...
void Bureau::drawItems()
{
    ...
    Cuboid(Point(top.x - 3, 17, top.z - 2), 0.1f, 6, 5).draw(); // small paper
    Cuboid(Point(top.x - 4, 17, top.z - 4), 0.1f, 6, 6).draw(); // small paper
    Cuboid(Point(top.x + 3, 17, top.z - 3), 0.1f, 5, 3).draw(); // another paper
    ...
    Cuboid(Point(body.center.x,17, body.center.z + 5),
    ...
    Cuboid(Point(body.center.x, 17.5, body.center.z + 5),
    ...
    Cuboid(Point(body.center.x,18, body.center.z + 5),
    ...
    Cuboid(Point(body.center.x + 3, 17, body.center.z + 5),
